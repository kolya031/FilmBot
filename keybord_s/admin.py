...
admin_menu_main.row(InlineKeyboardButton(text='🗒 Списки фильмов', callback_data='list_data_admin'))
...
admin_menu_main.row(InlineKeyboardButton(text='➕ НЕ НАЖИМАТЬ', callback_data='add_chennel_admin'))
admin_menu_main.insert(InlineKeyboardButton(text='➖ НЕ НАЖИМАТЬ', callback_data='delete_chennel_admin'))
admin_menu_main.row(InlineKeyboardButton(text='⭐ Проверка каналов', callback_data='check_chennel_admin'))
admin_menu_main.row(InlineKeyboardButton(text='▶️ Плееры', callback_data='player_settings_admin'))
admin_menu_main.row(InlineKeyboardButton(text='⚙ Настройки', callback_data='text_settings_admin'))
...
admin_menu_list.row(InlineKeyboardButton(text='⬅️ Назад', callback_data='back_main_menu_admin'))
...
admin_menu_text.row(InlineKeyboardButton(text='⬅️ Назад', callback_data='back_main_menu_admin'))
